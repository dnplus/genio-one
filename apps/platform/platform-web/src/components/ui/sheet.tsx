...
function SheetContent({
  ...
  return (
    <SheetPortal container={presentation === "workspace" ? workspaceContainer : undefined}>
      <SheetOverlay className={presentation === "workspace" ? "absolute" : undefined} />
      <SheetPrimitive.Popup
        data-slot="sheet-content"
        data-presentation={presentation}
        data-side={presentation === "side" ? side : undefined}
        className={cn(
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className={cn("absolute right-3", presentation === "workspace" ? "top-4" : "top-3")}
                size="icon-sm"
              >
                <XIcon />
