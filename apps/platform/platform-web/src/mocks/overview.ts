...
export function createMockOverview(): OverviewSnapshot {
  ...
  return {
    ...
    accessGroups: {
      tenant_id: tenantId,
      groups: [
        { tenant_id: tenantId, organization_id: null, access_group_id: "access-group-ai-platform", display_name: "AI Platform", description: "People with AI Platform access.", enabled: true, revision: 1, membership_sources: [{ source_id: "manual", kind: "MANUAL" as const, revision: 1, subject_ids: ["ai-owner", "ai-user"], created_at: now - 120 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" }], created_at: now - 120 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" },
        { tenant_id: tenantId, organization_id: null, access_group_id: "access-group-api-platform", display_name: "API Platform", description: "API owners and application operators.", enabled: true, revision: 1, membership_sources: [{ source_id: "manual", kind: "MANUAL" as const, revision: 1, subject_ids: ["api-owner", "api-user"], created_at: now - 110 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" }], created_at: now - 110 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" },
        { tenant_id: tenantId, organization_id: null, access_group_id: "access-group-security", display_name: "Security Operations", description: "Security analysts using governed SaaS access.", enabled: true, revision: 1, membership_sources: [{ source_id: "manual" as const, kind: "MANUAL" as const, revision: 1, subject_ids: ["access-owner", "access-user"], created_at: now - 100 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" }], created_at: now - 100 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" },
        { tenant_id: tenantId, organization_id: null, access_group_id: "access-group-automation", display_name: "Automation Agents", description: "Registered agents with bounded engineering authority.", enabled: true, revision: 1, membership_sources: [{ source_id: "manual", kind: "MANUAL" as const, revision: 1, subject_ids: ["agent-operations", "agent-security"], created_at: now - 90 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" }], created_at: now - 90 * day, created_by: "platform-admin", updated_at: now - day, updated_by: "platform-admin" },
      ],
      memberships: [
